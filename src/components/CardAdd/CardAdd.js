     ...
     
      {
        isVisible ? <>
          ...
          <div onClick={  () => {
            ...
            <svg viewBox="0 0 24 24" width="100" height="100" stroke="#acb4fb" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
          </div>
